...
<head>
    ...
    <meta name="keywords"
        content="AI Art Gemini, AI Art DALL-E, AI Image Generator Prompts, Free AI Prompts, AI Art Prompts, AI Art Gallery, Midjourney prompts, Stable Diffusion prompts, Leonardo AI prompts, AI prompt library, AI prompt gallery">
    ...
    <!-- adsens e verification -->
    <meta name="google-adsense-account" content="ca-pub-2182585176352249">

    <!-- google tag manager -->
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-3J48DCL3XP"></script>
    <script>
    ...
    <meta name="monetag" content="c54abc4d8b484743fd5e8127adfc18fc">

    <script>
    (function(s) {
        s.dataset.zone = '10293324', s.src = 'https://al5sm.com/tag.min.js'
    })([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))
    </script>

    <!-- Ad Scripts (unchanged) -->
    <script type='text/javascript' src='//pl27875664.effectivegatecpm.com/84/83/93/848393a06a358b10af876c6a54c60926.js'>
    </script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo $currentPage === 'instructions.php' ? 'active' : ''; ?>"
                            href="<?= $siteURL; ?>/instructions">
